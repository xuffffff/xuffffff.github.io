...
本科阶段，我保持了较好的专业学习成绩，GPA 为 4.0414/5，专业排名 3/85（3%），曾获东华大学一等奖学金（Top 5%）。在科研与竞赛中，我主要围绕脑机接口数据生成、多模态推荐系统、检索增强生成与大语言模型微调等方向开展工作，希望通过更可靠的生成建模与跨模态表示学习方法，提升模型在真实复杂场景中的鲁棒性与可用性。
...
*2024.11 - 至今，独立一作，neurocomputing 在审*
